...
Java_org_bchatfoundation_libbchat_1util_image_WebPUtils_reencodeWebPAnimation(JNIEnv *env,
                                                                                   jobject thiz,
                                                                                   jbyteArray input,
                                                                                   jlong timeout_ms,
                                                                                   jint target_width,
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_org_bchatfoundation_libbchat_1util_image_WebPUtils_encodeGifToWebP(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jbyteArray input,
                                                                             jlong timeout_mills,
                                                                             jint target_width,
