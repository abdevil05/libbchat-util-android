...
private typealias BChatId = String

object BChatEncrypt : LibBChatUtilCApi() {
    /**
     * Decrypts data using the BChat protocol for a blinded recipient.
     *
     ...
     * @return A pair of the sender's bchat ID and the decrypted message.
     */
    ...
    /**
     * Encrypts data using the BChat protocol for a blinded recipient.
     *
    ...
    /**
     * Encrypts data using the BChat protocol for `recipientX25519PublicKey`.
     *
    ...
    /**
     * Decrypt data using the BChat protocol.
     *
