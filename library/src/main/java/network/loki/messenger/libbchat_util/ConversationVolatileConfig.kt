...
class ConversationVolatileConfig private constructor(pointer: Long): ConfigBase(pointer), MutableConversationVolatileConfig {
    ...
    external override fun getClosedGroup(bchatId: String): Conversation.ClosedGroup?
    external override fun getOrConstructClosedGroup(bchatId: String): Conversation.ClosedGroup
    external override fun eraseClosedGroup(bchatId: String): Boolean
