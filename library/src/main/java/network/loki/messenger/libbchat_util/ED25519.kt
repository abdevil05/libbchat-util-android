...
import network.loki.messenger.libbchat_util.util.KeyPair

object ED25519 : LibBChatUtilCApi() {
    /**
     ...
     *
     * @param ed25519Seed The seed the user uses to generate their bchat id
     * @return The libsodium-style Master BChat Pro Ed25519 secret key, 64 bytes.
     */
